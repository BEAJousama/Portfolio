...
export default function Header() {
  ...
  useEffect(() => {
    const observerOptions = {
      root: null,
      // Treat a section as active when its upper half is in view,
      // and give more weight to the most visible section.
    ...
    const observerCallback: IntersectionObserverCallback = (entries) => {
      ...
      const targetElement = mostVisible?.target as HTMLElement | undefined
            ...
            <div className="md:hidden">
              <svg className="w-12 h-12" viewBox="0 0 532 360" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g style={{ transformOrigin: "180px 180px", transform: `rotate(${scrollProgress * 360}deg)` }}>
                  <circle cx="180" cy="180" r="148" stroke={theme === "dark" ? "#fff" : "#fff"} strokeWidth="64" fill="none" strokeDasharray="233 930" style={{ transition: "transform 0.05s linear" }} />
                </g>
