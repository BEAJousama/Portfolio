    ...
    <div className="loading-screen w-screen h-screen bg-background flex items-center justify-center z-50">
      ...
      <style jsx>{`
        ...
        .progress-bar-loading::after {
          ...
          bottom: 0;
          width: 20px;
          background: linear-gradient(90deg, transparent, var(--accent-foreground));
